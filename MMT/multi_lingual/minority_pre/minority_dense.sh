...
#SBATCH -o minority_pre_dense.out
...
do
    ...
    bash multi_lingual/minority_pre/score.sh $save_dir/$sparsity/ ${save_dir}_$sparsity $path_2_data $lang_list $lang_pairs 
    # Delete Best Model to save storage
    rm -rf $save_dir/$sparsity/checkpoint_best.pt
    rm -rf $save_dir/$sparsity/checkpoint_last.pt
    rm -rf $save_dir/$sparsity/checkpoint_1_0.pt
done
# Calculate Scores
