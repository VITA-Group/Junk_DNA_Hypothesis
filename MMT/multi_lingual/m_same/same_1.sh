...
lang_pairs=en-de,en-es,es-en,de-en
...
do
    ...
    bash multi_lingual/same/score.sh $save_dir/$sparsity/ ${save_dir}_$sparsity $path_2_data $lang_list $lang_pairs 
