...
from lib.prune import prune_wanda, prune_magnitude, prune_sparsegpt, check_sparsity, find_layers, prune_magnitude_slicing
...
def main():
    ...
    if args.model == "lmsys/vicuna-7b-v1.3":
        file_name = f"./runs/vicuna7b_slicing/{args.prune_method}/context_{args.include_context}/trivia_{args.sparsity_ratio}_{args.sparsity_type}.txt"
    ...
    if args.prune_method == "wanda":
        ...
        prune_magnitude_slicing(args, model, tokenizer, device, prune_n=prune_n, prune_m=prune_m)
